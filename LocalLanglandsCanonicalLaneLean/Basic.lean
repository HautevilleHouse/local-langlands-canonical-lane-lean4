/-!
# local-langlands-canonical-lane Lean migration boundary
...
`LocalLanglandsCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "local-langlands-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/local-langlands-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for Local Langlands Correspondence: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["canonical-lane", "galois-representations", "local-fields", "local-to-global", "manifold-constrained", "mathematical-proof", "representation-theory", "reproducibility", "local-langlands"]
