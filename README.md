# Local Langlands — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/local-langlands-canonical-lane-mathlib.git
cd local-langlands-canonical-lane-mathlib
lake exe
lake build
```
